...
var idMarca= $('#selMarcas option:selected').val();

console.log("idMarca:" + idMarca);

if (idMarca !='' && idMarca!=0)
        { 
        var condMarca = " id_marca=" + idMarca + " and ";
        }

/* familia, marca y modelo son claves foraneas, en el combo de seleccion usamos  comodin.nombre  que es lo que ira en la variable campo */
var sql  ="select id, nombre from modelo where " + condMarca + "nombre like '%" + patron + "%'";
...
$('#selMarcas').change(function (event) { 

var idMarca = this.value;

var condMarca = "id_marca=" + idMarca  + " ";

var modelo =$('#patronModelo').val();

var condModelo='';

if (modelo !='')
        { 
        var condModelo = " and nombre like '%" + modelo+ "%'' ";
        }

/* familia, marca y modelo son claves foraneas, en el combo de seleccion usamos  comodin.nombre  que es lo que ira en la variable campo */
var sql  ="select id, nombre from modelo where " + condMarca + condModelo;
